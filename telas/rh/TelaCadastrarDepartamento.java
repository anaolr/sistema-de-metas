...
public class TelaCadastrarDepartamento {
    private JFrame janelaCadastrarDepartamento;
    private JButton botaoColaborador, botaoDepartamento, botaoPremio, botaoHistorico, botaoHistoricoColaboradores, botaoSair, botaoSalvar,
            botaoLimpar;
    ...
    public TelaCadastrarDepartamento() {
        ...
        // Título
        JLabel tituloCadastro = new JLabel("CADASTRAR DEPARTAMENTO", SwingConstants.CENTER);
